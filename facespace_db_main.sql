...
CREATE TABLE FRIENDSHIPS (
	...
	USER_ID1 NUMBER(10),
	USER_ID2 Number(10),
	FRIEND_STATUS NUMBER(1) DEFAULT 0, --0 means it is pending
...
---- simply keeps track of each user who is a part of a group. allows for one user to be a prt of multiple groups
